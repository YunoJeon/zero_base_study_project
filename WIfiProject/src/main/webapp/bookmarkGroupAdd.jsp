...
<form id="add-group-form" action="${pageContext.request.contextPath}/bookmarkGroup" method="post" accept-charset="UTF-8">
    <table>
        <colgroup>
        ...
        <tr>
            ...
            <td><input type="text" id="group-name" name="group-name" required></td>
        </tr>
        <tr>
            <th><label for="group-order">순서</label></th>
            <td><input type="number" id="group-order" name="group-order" required></td>
        </tr>
        <tr>
            <td colspan="2" class="centered"><button type="submit">추가</button></td>
        </tr>
    </table>
</form>
